...
description: PowerShell script to add a new group and user to AD.
date: 2026-06-08
---
<pre><code>
New-ADOrganizationalUnit -Name "TopSecret" -Path "DC=patd,DC=com" -ProtectedFromAccidentalDeletion $false -OtherAttributes @{"cn"="TopSecret"}
...
Add-ADGroupMember -Identity "TopSecret" -Members "ghopper"
</code></pre>